...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    ...
    sidebarMenu(id = "tab",
      ...
      menuItem("PCA", tabName = "PCA", icon = icon("pie-chart")),
  ...
  dashboardBody(
    ...
    tabItem(tabName = "ExploreCorrelation",
            ...
            fluidRow(
              box(title = "Correlogram", status = "primary", solidHeader = TRUE, width = 10,
                  plotOutput("CorrelogramPlot",height="600px") 
              )
            )
    ...
    tabItem(tabName = "PCA",
            ...
            fluidRow(
              box(title = "Running PCA", status = "primary", solidHeader = TRUE,width = 10,
                  actionButton('RunPCA', label="PCA", icon = icon("ok", lib = "glyphicon"))
              )
            ),
            fluidRow(
              box(id = "Box_SMOTE_CaseStats1",title = "Class Balance", status = "primary", solidHeader = TRUE,width = 10,collapsible = TRUE,collapsed = TRUE,
                  plotOutput("Plot_SMOTE_Old_CaseStats",height = '600px'),
            ...
            fluidRow(
              box(id = "Box_SMOTE_Dataset", title = "New Dataset", status = "primary", solidHeader = TRUE,collapsible = TRUE, collapsed = TRUE,width = 10,
                  verbatimTextOutput("dtSMOTEresult")
              )
            )
